...
data_train = fetch_20newsgroups(subset='train', categories=categories,
                                ...
                                remove=remove)
data_train.data = featureMat[:no_of_training_example,:]
data_train.target = targets[:no_of_training_example]
data_test = fetch_20newsgroups(subset='test', categories=categories,
                               shuffle=True, random_state=42,
                               remove=remove)
print('data loaded')
categories = labels#data_train.target_names    # for case categories == None
